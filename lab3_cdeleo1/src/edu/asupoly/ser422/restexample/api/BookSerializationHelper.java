...
/*
 * This is an example of a simple custom serializer (converts a Java object to a 
 * JSON string).
 * 
 * Note all this one does is rename the property keys for Book, but what you do 
 * in the serialize method is entirely up to you, so you may generalize to as 
 * rich a hypermedia format as you like.
 * 
 * Note that you would typically write a deserializer as well when you customize 
 * the JSON. A deserializer goes in the opposite direction, converting JSON to a 
 * Java object. So, in this case
 */
public final class BookSerializationHelper {
    ...
    private final static BookSerializationHelper __me = 
            new BookSerializationHelper();
    ...
    public Book consumeJSON(String json) throws IOException, 
    ...
    final private class BookJSON extends JsonSerializer<Book> {
        ...
        @Override
        public void serialize(Book book, JsonGenerator jgen, 
