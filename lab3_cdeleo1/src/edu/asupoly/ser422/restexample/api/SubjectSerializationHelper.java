...
public final class SubjectSerializationHelper {
    ...
    private final static SubjectSerializationHelper __me = 
            new SubjectSerializationHelper();
    ...
    public Subject consumeJSON(String json) throws IOException,
    ...
    final private class JSONSubject extends JsonDeserializer<Subject> {
        ...
        @Override
        public Subject deserialize(JsonParser parser, 
    ...
    final private class SubjectJSON extends JsonSerializer<Subject> {
        ...
        @Override
        public void serialize(Subject subject, JsonGenerator jgen, 
