...
public class RDBMBooktownServiceImpl extends ABooktownServiceImpl {
    ...
    public boolean deleteBook(int bookId) {
        ...
        try {
            ...
            if (rval = (stmt.executeUpdate() > 0)) {
                stmt2 = conn.prepareStatement(__dbProperties.getProperty("sql.removeBook"));
    ...
    public boolean updateSubject(Subject subject) {
        ...
        try {
            conn = getConnection();
            stmt = conn.prepareStatement(__dbProperties.getProperty("sql.updateSubject"));
            stmt.setString(1, subject.getLocation());
